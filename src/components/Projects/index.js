    ...
    <Container id="projects">
      <Wrapper>
        ...
        <ToggleButtonGroup >
          ...
          <Divider />
          {toggle === 'vba app' ?
            <ToggleButton active value="vba app" onClick={() => setToggle('vba app')}>VBA-BASED APP'S</ToggleButton>
            :
            <ToggleButton value="vba app" onClick={() => setToggle('vba app')}>VBA-BASED APP'S</ToggleButton>
          }
        </ToggleButtonGroup>
        <CardContainer>
          {toggle === 'all' && projects
